...
func main() {
	...
	render("Linux", ss)
	ss = fetchGithub(client, "zfsonlinux", "zfs", 2, 2)
	render("zfs", ss)
	ss = fetchGithub(client, "pfsense", "pfsense", 2, 2)
	render("pfSense", ss)
	ss = fetchGithub(client, "rust-lang", "rust", 2, 2)
	render("rust", ss)
	ss = fetchGithub(client, "golang", "go", 2, 2)
	render("golang", ss)
	ss = fetchGithub(client, "kubernetes", "kubernetes", 2, 5)
	render("kubernetes", ss)
	ss = fetchGithub(client, "nginx", "nginx", 2, 2)
	render("nginx", ss)
	ss = fetchGithub(client, "envoyproxy", "envoy", 2, 2)
	render("envoy", ss)
	ss = fetchGithub(client, "istio", "istio", 2, 2)
	render("istio", ss)
	ss = fetchGithub(client, "linkerd", "linkerd2", 1, 4)
	render("l5d2", ss)
	ss = fetchGithub(client, "hashicorp", "terraform", 2, 2)
	render("terraform", ss)
	ss = fetchGithub(client, "gohugoio", "hugo", 2, 1)
	render("hugo", ss)
}
